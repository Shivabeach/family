...
$(function() {
    ...
    $('A[rel="external"]').click(function() {
        window.open($(this).attr("href"), rel = "noopener noreferrer");
        return false;
...
$(function() {
    ...
    $("li.inliner").on("click", function() {
        //click on the li. CHANGE TO REFLECT NEW LI
        var content = $(this).text();
        //content is the text that you clicked on
...
$(".boldtrigger").click(function() {
    //boldTrigger being the element initiating the trigger
