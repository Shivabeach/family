...
<div class="container">
  ...
  <section class="flex-one item">
    ...
    <div class="dnablock">
      <h3 id="top">From the Beginning MDNA</h3>
        <p class="mid-size">Branch: L3</p>
          <p>Age: 67,000 Years Ago</p>
    ...
    <div class="dnablock">
        ...
        60,000 years ago
          ...
          <p class="mid-size">Branch: N</p>
          <p>Age: About 60,000 Years Ago</p>
    ...
    <div class="dnablock">
        ...
        <p class="mid-size">Branch: N</p>
          <p>Age: About 55,000 Years Ago</p>
      ...
      <div class="dnablock">
        ...
        <p class="mid-size">Branch: N</p>
          <p>Age: About 35,000 Years Ago</p>
          <p>Location of Origin: West Asia</p>
    </div> 
  ...
  <footer class="flex-four border">
    <h3>Footnotes</h3>
    <ul>
    <li><sub>1</sub> All information on page from <a href="https://genographic.nationalgeographic.com/" rel="external">The Genographic Project</a> based on my DNA tests </li>
  </footer>
</div>