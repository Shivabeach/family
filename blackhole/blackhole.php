...
$blackhole_badbot = 0;
$blackhole_filename = 'blackhole/blackhole.dat';
$blackhole_ipaddress = sanitize($_SERVER['REMOTE_ADDR']);
$blackhole_useragent = sanitize($_SERVER['HTTP_USER_AGENT']);

if (preg_match("/(aolbuild|bingbot|bingpreview|msnbot|duckduckgo|adsbot-google|googlebot|mediapartners-google|teoma|slurp|yandex)/i", $blackhole_useragent)) {
